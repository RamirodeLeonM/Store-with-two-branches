...
$registros =("SELECT P.COD_PRODUCTO AS 'CODIGO', P.NOMBRE, P.DESCRIPCION, P.MARCA, P.CATEGORIA AS 'ID CAT', C.DESCRIPCION AS 'CATEGORIA', P.PRECIOCOSTO, P.PRECIOUNIT, P.CANTIDAD AS 'STOCK', P.COD_PROVEEDOR AS 'CODIGO PROVEEDOR' FROM producto P, categoria C  
