		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Nuestros proveedores son nuestra garantia de calidad.
				</p>
			</div>
		</section>
			...
			<div class="mdl-cell mdl-cell--12-col">
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content">
						<form action="1insertarproveedor.php" method="post" name="form">
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
		                            <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; INFORMACION DEL PROVEEDOR</legend><br>
		                        </div>
								...
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="phoneCompany">EMPRESA</label>
							...
							<p class="text-center">
								...
								<div class="mdl-tooltip" for="btn-addCompany">AGREGAR PROVEEDOR</div
									>
