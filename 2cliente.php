		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					El cliente es lo mas importante para nuestra empresa.
				</p>
			</div>
		</section>
			...
			<div class="mdl-cell mdl-cell--12-col">
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content">
						<form action="1insertarcliente.php" method="post" name="form">
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
		                            <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; INFORMACION DEL CLIENTE</legend><br>
		                        </div>
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="COD_CLIENTE">
										<label class="mdl-textfield__label" for="DNICompany">CODIGO DEL CLIENTE</label>
								...
								<div class="mdl-cell mdl-cell--12-col">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="addressCompany">APELLIDO</label>
										<span class="mdl-textfield__error">Invalid address</span>
									</div>
								</div>
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="number" name="DPI">
										<label class="mdl-textfield__label" for="emailCompany">DPI</label>
								...
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="urlCompany">DIRECCION</label>
										<span class="mdl-textfield__error">Invalid web</span>
									</div>
								</div>
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="number"  name="NIT">
										<label class="mdl-textfield__label" for="phoneCompany">NIT</label>
							...
							<p class="text-center">
								...
								<div class="mdl-tooltip" for="btn-addCompany">AGREGAR CLIENTE</div
									>
